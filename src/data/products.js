export const products = {
  1: {
    ...
    images: [
      ...
      "https://i.postimg.cc/NFMf3YFP/exemploozenfit.jpg",
      "https://i.postimg.cc/D0MyFDbf/exemplozenfit2.jpg"
    ],
    benefits: [
  ...
  2: {
    ...
    images: [
      ...
      "https://i.postimg.cc/vBGmv5sy/diuri2.png",
      "https://i.postimg.cc/W3S1YtNk/diuri3.png"
    ],
    benefits: [
      "Queima Gordura Localizada",
      "Reduz Medidas",
    ...
    usage: "Diluir 1 colher (5g) em 200ml de água gelada. Tomar 1 vez ao dia, preferencialmente antes do café da manhã.",
    ingredients: "L-Carnitina, Colágeno Hidrolisado, Vitamina C, Cromo, Zinco, Selênio",
    specifications: {
      "Quantidade": "300g",
      "Duração": "30 dias",
      "Garantia": "30 dias",
